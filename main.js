...
const messages = [
    "Tap dimana aja yaaa",
    "hey kamu ❤️",
    "mood kamu lagi kurang bagus yaa",
    "atutuu pacar aku moodnya lagi kurang bagus",
    "semoga dengan ini mood kamu bisa lebih happy yaa my love",
    "karena aku seneng kalo bisa melihat pacar aku happy",
    "karena kebahagian aku ada di kamu saaayaanggggggg",
    "because you are my love",
    "my girlfriend",
    "my home",
    "my world",
    "and more than everything",
    "udah cukup gombalnya hehee",
    "coba sayang pencet",
    "coba sekali lagi aku mau ngomong penting bangett buat sayang reva ",
    "aku cuma mau bilang",
